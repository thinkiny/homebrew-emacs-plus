...
class EmacsPlusAT32 < EmacsBase
  ...
  if ENV['HOMEBREW_EMACS_PLUS_32_REVISION']
    url "https://github.com/emacs-mirror/emacs.git", :revision => ENV['HOMEBREW_EMACS_PLUS_32_REVISION']
  else
